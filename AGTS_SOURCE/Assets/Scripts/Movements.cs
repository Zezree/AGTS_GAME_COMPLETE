...
{
    //Pohyb a používání zbraní Playera
	...
	void Awake() //Najití hráče - PlayerLegs aby se mu hybali nohy 
	{
	...
	void Update() //Pohyb hráče locknutí kamery na Playera pokud dostal hit(zásah) a pohyb nohou
	{
	...
	void rotateLegs(float inputRight, float inputUp) //Pohyb nohou
	{
	...
	public void dealDamage() //Umrtí Playera
	{
		this.neededHitsToDie--;

		if (this.neededHitsToDie == 3)
		{
			Debug.Log("YOU DEAD");
		}
	}
